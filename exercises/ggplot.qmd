...
sont finalement assez complexes pour le peu d'information
qu'ils transmettent. Les _lollipop charts_ sont préférables: ils
...
- Des séries instructives sur la dynamique temporelle
...
1. Utiliser la fonction `format` pour créer une variable `mois`
