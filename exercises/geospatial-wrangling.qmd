...
pour télécharger les données communales (produit `Admin Express` de l'IGN)
des départements de la petite couronne (75, 92, 93 et 94). L'argument à utiliser
...
Un concept central dans les logiciels de GIS est la notion de système de
...
Voici un code pour récupérer les frontières françaises (découpées par région)
...
Avec la carte à la question 3, basée sur des aplats de
couleurs (_choropleth map_), le lecteur est victime d'une illusion
classique. Les arrondissements 
