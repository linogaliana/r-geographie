...
comme un SIG. Grâce à la librairie `sf`, une extension
...
En ce qui concerne Paris, à l'issue de la question 5, la carte
...
mais on propose ici d'utiliser à nouveau
...
La méthode pour faire des cartes contextuelles
...
|`st_is_within_distance()` | 	Quelles géométries de x est à moins de 
m/km de celles de y ? |
...
2. Représenter la carte des stations du 19e arrondissement (s'aider de la variable `NOM`). Vous pouvez mettre en fond de carte les arrondissements parisiens. 
